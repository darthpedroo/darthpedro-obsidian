...
En un jurado se dicen los castigos que tendrá el acusado antes de empezar el juicio. Esto **NO ES AD MISERICORDIAM PORQUE ES UN PROCEDIMIENTO LEGAL**. Sin embargo, si el abogado intenta dice esto tratando de apelar a la misericordia del juez, sí es **ad misericordiam.** ad ignorantiam 
...
![Image Description](/darthpedro-obsidian/images/Pasted%20image%2020250504124725.png)
Si la verdad de una proposición se afirma con base en la autoridad de alguien que **no tiene competencia especial en ese ámbito, se comete esta falacia.** 
Es una apelación a alguien que no tiene legitimidad para reclamar autoridad

**EJEMPLO:**
En los anuncios, se muestran a famosos tomando bebidas de marca y este nos incita a comprarla. Sin embargo, su testimonio no es legítimo para darle validez a que esa marca es superior. 

### 3) Causa Falsa ( argumento non causa pro causa )
![Image Description](/darthpedro-obsidian/images/Pasted%20image%2020250504130340.png)

Cuando presuponemos una conexión causal que no existe. 

**EJ**:

En la epoca primitiva. El sol sale tras un eclipse al tocar los tambores a la noche. -> **FALACIA POST HOC ERGO PROPTER HOC** -> Después de tal cosa; por lo tanto, debido a tal cosa. 

**Argumento de la pendiente resbaladiza**: Es falaz decir que al realizar una acción en una dirección determnada, se tomarán cambios en la misma dirección.

![Image Description](/darthpedro-obsidian/images/Pasted%20image%2020250504125757.png)



### 4) Generalización precipitada ( accidente inverso )
![Image Description](/darthpedro-obsidian/images/Pasted%20image%2020250504130452.png)

Esta falacia se comete cuando sacamos conclusiones acerca de **todas las personas o cosas de una determinada clase** con base en el conocimiento de un único elemento de dicha clase.

**EJ:**
- Estereotipos raciales
- Generalizaciones erroneas de un presidente

Una anecdota puede ser un acompañante relevante, pero no es suficiente para justificar una premisa. Aquí un ejemplo falaz:

![Image Description](/darthpedro-obsidian/images/Pasted%20image%2020250504130305.png)
...
### 1) Falacia del accidente

Las circunstancias alteran los casos. Una generalización que es verdadera en muchos casos  puede no aplicarse en un caso determinado. Si se ignoran dichas circunstancias accidentales y generalizamos, cometemos esta falacia.

### 2) Pregunta compleja
![Image Description](/darthpedro-obsidian/images/Pasted%20image%2020250504132441.png)

Se hace una pregunta de tal manera que se presuponga la verdad de una conclusión oculta en esa pregunta. 

![Image Description](/darthpedro-obsidian/images/Pasted%20image%2020250504131807.png)

Se presupone que el calentamiento global no existe.

EJ: **Respuestas por si o por no**

![Image Description](/darthpedro-obsidian/images/Pasted%20image%2020250504132017.png)

**Se infiere falazmente tras negar o afirmar una pregunta compleja**

![Image Description](/darthpedro-obsidian/images/Pasted%20image%2020250504132235.png)

Cada supuesto debe negarse individualmente. -> **LA CARGA NEGATIVA**

### 3) Petición de principio ( petito principii )
![Image Description](/darthpedro-obsidian/images/Pasted%20image%2020250504133738.png)

Asumir la verdad de lo que uno intenta probar en el intento de probarlo. Las premisas del argumento no son irrelevantes, pues prueban la conclusión. Sin embargo, lo hacen de una manera trivial. **Petitio principii** siempre es válida, pero inútil. 

**HUME**: 
Determinó que el argumento : "Las leyes de la naturaleza funcionaran mañana como han funcionado hoy; que en lo básico de la naturaleza es esencialmente uniforme , y que , por lo tanto , podemos confiar en la experiencia pasada para guiar nuestra conducta en el futuro. Qué el futuro será esencialmente como el pasado" **es inválido**. 

Se busca discutir si la naturaleza **continuará** comportandose regularmente, que lo haya hecho así antes no puede ser prueba de que lo hará en el futuro.

**¿Cómo podemos saber que los futuros futuros serán como los futuros pasados?**
